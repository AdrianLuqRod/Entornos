...
/******************************************************************
 * BadMoney program This program demonstrates the inaccuracies that can occur
 * from using a floating point variable to represent money. NO user input of
 * data is required.
 * 
 * @author J. Dalbey 2/7/2000 Assignment: Examine the code and write down your
 *         prediction of the output. Then compile and execute the program to
 *         obtain the actual results. If your prediction was incorrect, research
 *         the cause and write up a detailed technical explanation for the
 *         observed results.
 ************************************************************/
